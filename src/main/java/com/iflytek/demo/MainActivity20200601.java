...
// * main方法，无ui版
// * 20200601版：
// *  1.demo.MainActivity：去掉while(speak_finished)后，可以拿到识别结果，但一句话说完后程序不会自动退出。
// * 	2.android主线程中不能用socket，和语义端通信方法另选；（主线程用socket会报错：W/System.err: android.os.NetworkOnMainThreadException）
// *
// * 现状：目前单次跑能识别到，并拿到结果
// */
//public class MainActivity20200601 extends Activity implements OnClickListener {
...
////        int count = 0;
//        //开始识别，并设置监听器
////        while (speak_finished == false) {     // 当speak_finished==false，说明说话还没结束，循环等待
//            try {
////                count += 1;
////                System.out.println("===== " + count);
////                lastResult.delete(0, lastResult.length());    // 清空保存结果的变量
//
////                socket = new Socket(host, port);
//                // 安卓不能这样从键盘输入
////                System.out.println("有人来没？y/n");    // 其他系统发来个信号
////                Scanner scanner = new Scanner(System.in);
////                String s = scanner.next();
////                if ("y".equals(s)) {
//                    if (speak_finished == true) {
//                        Thread.sleep(2000);    // 延时下，再打开
////                    mRecognizerListener.onBeginOfSpeech();
//
//                        int ret1 = mIat.startListening(mRecognizerListener);
...
//                e.printStackTrace();
//            }
//            // 去掉while循环后，程序并没有执行到这里（有while循环时会，但拿不到识别结果）
////            System.out.println("++++++++++++++++++++++++++++++++" + speak_finished + "++++++++++++++++++++++++++++++++");
////        }
//
//    }
//
