...
//        mIatDialog = new RecognizerDialog(this,mInitListener);
        ...
        System.out.println("mIat: " + mIat);
        System.out.println("mIatDialog:" + mIatDialog);
        System.out.println("mResultText:" + mResultText);

        OneShotActivity.SimpleAdapter listitemAdapter = new OneShotActivity.SimpleAdapter();
...
//            Log.d(TAG, "当前音量大小：" + volume + "，返回音频数据：" + data.length);
    ...
    private class SimpleAdapter extends BaseAdapter {
        public View getView(int position, View convertView, ViewGroup parent) {
            if (null == convertView) {
                LayoutInflater factory = LayoutInflater.from(OneShotActivity.this);
                View mView = factory.inflate(R.layout.list_items, null);
                convertView = mView;
            }
            Button btn = (Button) convertView.findViewById(R.id.btn);
            btn.setOnClickListener(OneShotActivity.this);
            btn.setTag(position);
