 ...
 * tcp nio服务端
 */
public class TcpNioServer extends Activity implements View.OnClickListener {
...
//                closeConn();    // 停止听写后关闭连接
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SpeechUtility.createUtility(TcpNioServer.this, "appid=" + getString(R.string.app_id));
