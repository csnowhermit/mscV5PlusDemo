...
/**
 * Iat，在OnCreate()中用while(true)实现阶段启动监听
 */
public class IatActivitySocketWhileInMain extends Activity implements View.OnClickListener {
...
//            }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SpeechUtility.createUtility(IatActivitySocketWhileInMain.this, "appid=" + getString(R.string.app_id));
